...
![shrink-perturb](/pics/pbtnas/shrink_perturb_spectrum.png){: style="width: 75%;" .needs-light-bg }
{: refdef}
...
{:refdef: style="text-align: center;"}
![PBT-NAS](/pics/pbtnas/PBT_NAS_scheme.png){: style="width: 100%;" .needs-light-bg }
{: refdef}
